  ...
  return (
    <article className="prose-none flex max-w-2xl flex-col gap-6 text-[17px] leading-8">
      ...
      <ol className="list-decimal pl-5">
        ...
        <li>
          Continue with Google (Clerk) creates an app user. Access is free for now.
        </li>
        <li>
          Vaaya shortlist calls are off for now so credits are not spent on every
          signed-in user. The ranking is cached and shared. After a short fetch the
          dashboard shows four distinct listings.
        </li>
      ...
      <p>
        ...
        If a name is missing there, Tickertape ratios are used when present. Vaaya
        shortlist research is paused so credits are not spent on every login. Screener,
